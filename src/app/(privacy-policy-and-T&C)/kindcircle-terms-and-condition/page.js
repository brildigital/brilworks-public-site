...
export async function getPrivacyPolicy() {
  try {
    const storyUrl = `https://api.storyblok.com/v2/cdn/stories/kindcircle-terms-and-condition?version=${process.env.NEXT_PUBLIC_STORYBLOK_VERSION}&token=${process.env.NEXT_PUBLIC_ACCESS_TOKEN}`;
