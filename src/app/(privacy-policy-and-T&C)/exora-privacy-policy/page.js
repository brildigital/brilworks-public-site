...
export async function getPrivacyPolicy() {
  try {
    const storyUrl = `https://api.storyblok.com/v2/cdn/stories/exora-privacy-policy?version=${process.env.NEXT_PUBLIC_STORYBLOK_VERSION}&token=${process.env.NEXT_PUBLIC_ACCESS_TOKEN}`;
