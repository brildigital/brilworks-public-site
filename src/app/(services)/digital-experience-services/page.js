...
import DigitalExperienceService from "@/app/components/Services/DigitalExperienceService";
...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://brilworks-storyblok-assets.s3.eu-central-1.amazonaws.com/assets/ee4ef3dd60_digital-experience-banner.webp",
      },
    ],
    locale: "en-US",
    type: "website",
