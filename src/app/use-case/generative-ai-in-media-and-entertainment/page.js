...
export const metadata = {
  title: "Generative AI in Media and Entertainment",
  description:
    "Top use cases of generative AI in media and entertainment, generative AI can help in writing content, story, creating video animations, and artwork.",
  openGraph: {
    title: "Generative AI in Media and Entertainment",
    description:
      "Top use cases of generative AI in media and entertainment, generative AI can help in writing content, story, creating video animations, and artwork.",
    url: `${process.env.NEXT_PUBLIC_BASE_URL}use-case/generative-ai-in-media-and-entertainment/`,
    siteName:
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_BASE_URL}use-case/generative-ai-in-media-and-entertainment/`,
  },
};

async function getAWSInHealthcareData() {
  try {
    const url = `https://api.storyblok.com/v2/cdn/stories/use-case/generative-ai-in-media-and-entertainment?version=${process.env.NEXT_PUBLIC_STORYBLOK_VERSION}&token=${process.env.NEXT_PUBLIC_ACCESS_TOKEN}`;
