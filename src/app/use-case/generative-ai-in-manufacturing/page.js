...
export const metadata = {
  ...
  description:
    "Discover the top generative AI use cases to learn how AWS is transforming manufacturing. Generative AI in manufacturing enables automation and improves efficiency and productivity.",
  openGraph: {
    title: "Generative AI in Manufacturing",
    description:
      "Discover the top generative AI use cases to learn how AWS is transforming manufacturing. Generative AI in manufacturing enables automation and improves efficiency and productivity.",
    url: `${process.env.NEXT_PUBLIC_BASE_URL}use-case/generative-ai-in-manufacturing/`,
    siteName:
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_BASE_URL}use-case/generative-ai-in-manufacturing/`,
  },
};

async function getAWSInHealthcareData() {
  try {
    const url = `https://api.storyblok.com/v2/cdn/stories/use-case/generative-ai-in-manufacturing?version=${process.env.NEXT_PUBLIC_STORYBLOK_VERSION}&token=${process.env.NEXT_PUBLIC_ACCESS_TOKEN}`;
