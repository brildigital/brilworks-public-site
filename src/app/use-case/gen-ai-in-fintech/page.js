...
export const metadata = {
  ...
  description: "At Brilworks, we specialize in developing generative AI application for fintech industry, offering cutting-edge custom AI application development services.",
  openGraph: {
    title: "Generative AI in Fintech",
    description: "At Brilworks, we specialize in developing generative AI application for fintech industry, offering cutting-edge custom AI application development services.",
    url: `${process.env.NEXT_PUBLIC_BASE_URL}use-case/gen-ai-in-fintech/`,
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_BASE_URL}use-case/gen-ai-in-fintech/`,
  },
};

async function getAWSInHealthcareData() {
  try {
    const url = `https://api.storyblok.com/v2/cdn/stories/use-case/gen-ai-in-fintech?version=${process.env.NEXT_PUBLIC_STORYBLOK_VERSION}&token=${process.env.NEXT_PUBLIC_ACCESS_TOKEN}`;
