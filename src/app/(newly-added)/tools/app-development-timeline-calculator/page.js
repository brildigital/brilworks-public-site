...
export const metadata = {
  ...
  openGraph: {
    ...
    url: `${process.env.NEXT_PUBLIC_BASE_URL}tools/app-development-timeline-calculator/`,
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_BASE_URL}tools/app-development-timeline-calculator/`,
  },
};
