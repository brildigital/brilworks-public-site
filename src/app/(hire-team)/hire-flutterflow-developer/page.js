...
import FlutterflowTechnology from "@/app/components/Technologies/FlutterflowTechnology";
...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_BASE_URL}images/v2/flutterflow-banner.webp`,
      },
    ],
    locale: "en-US",
    type: "article",
