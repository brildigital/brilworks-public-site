...
import LowCodeNoCodeTechnology from "@/app/components/Technologies/LowCodeNoCodeTechnology";
...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_BASE_URL}images/v2/low-code-banner.webp`,
      },
    ],
    locale: "en-US",
    type: "article",
