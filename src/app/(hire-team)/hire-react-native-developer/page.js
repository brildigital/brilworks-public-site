...
import ReactNativeTechnology from "@/app/components/Technologies/ReactNativeTechnology";
...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_BASE_URL}images/v2/react-native-banner.webp`,
      },
    ],
    locale: "en-US",
    type: "article",
