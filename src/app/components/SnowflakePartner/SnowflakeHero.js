            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div>
                ...
                <div className="flex items-center gap-[11px] mb-6 hero-fade-down">
                  <span className="w-[30px] h-[30px] rounded-[7px] bg-[#29B5E8] flex items-center justify-center shrink-0">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                >
                  ...
                  <span className="text-[#29B5E8]">on Snowflake.</span>
                </h1>
                ...
                >
                  Brilworks is a certified Snowflake partner. We unify your data
                  on one platform, cut what you&apos;re overspending to run it,
                  and get AI into production on data your teams can trust.
                </p>
              ...
              <div className="hidden lg:flex justify-center items-center hero-fade-up">
                <div className="relative w-full max-w-[520px] aspect-square">
                  ...
                  {/* Image on top */}
                  <Image
                    src="/images/v2/snowflake_hero.webp"
                    alt="Snowflake data engineering and AI platform"
                    fill
