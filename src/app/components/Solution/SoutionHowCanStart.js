    ...
    <>
      <section className="solution_gradiant md:py-[4rem] py-[4rem]">
        <div className="w-[90%] mx-auto">
          ...
          <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-[2rem]">
            ...
            <div className="border-1 rounded-[30px] border-[#00dfb8] bg-[#fff] py-[4rem] px-[2rem]">
              ...
              <div className="service_description">
                <p>
                  We work with you to identify the project requirements and
                  share a project proposal with budget and timeline estimates.
                </p>
              </div>
            </div>
            ...
            <div className="border-1 rounded-[30px] border-[#00dfb8] bg-[#fff] py-[4rem] px-[2rem]">
              ...
              <div className="service_description">
                <p>
                  Once the project is approved & the NDA is signed, we will
                  assign our world-class team in an efficient & time-tested
                  manner.
                </p>
              </div>
            </div>
