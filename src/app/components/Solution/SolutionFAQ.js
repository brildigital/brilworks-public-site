...
const SolutionFAQ = () => {
  ...
  return (
    <div className="sec3_width_home faq-bottom mb-[5rem] pt-2 pb-10">
      ...
      <div className="reveal">
        <div itemscope="true" itemtype="https://schema.org/FAQPage">
          ...
          {pathname === "/industry/fleet-management-software-development/" &&
            fleetManagementFAQData.map((faq) => (
              <FAQAccordion
                key={faq.id}
                id={faq.id}
                question={faq.question}
          ...
          {pathname === "/industry/media-entertainment-software-development/" &&
            mediaEntertainmentFAQData.map((faq) => (
              <FAQAccordion
                key={faq.id}
                id={faq.id}
                question={faq.question}
