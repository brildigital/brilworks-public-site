...
const SolutionEngagementModal = () => {
  ...
  return (
    <section>
      <div className="container max-w-[1440px] main-section-padding mx-auto workpadd_borderTop">
                ...
                <div className="no_flex_height">
                  ...
                  <div className="service_description text-center mob_center">
                    <p>
                      ...
                      new talent. Hire dedicated developers in the time it takes
                      to hire one person.
                    </p>
                  </div>
                </div>
            ...
            <div className="steps_service flex items-center justify-center">
              <div className="no_flex">
                <div className="no_flex_height">
                  ...
                  <div className="service_description text-center mob_center">
                    <p>
                      Our project-based model gives you the confidence to engage
                      our team for the preparation, development, and ongoing
                      maintenance of your online presence.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="flex items-center justify-center xl:pt-[6rem] md:pt-[4rem] pt-8">
          <Button
