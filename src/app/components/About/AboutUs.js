...
const MISSION_VISION = [
  {
    ...
    features: ["Customer-first thinking", "Outcome-driven delivery", "End-to-end ownership"],
    reverse: false,
  },
  {
    ...
    features: ["Long-term partnerships", "Transparent communication", "Continuous innovation"],
    reverse: true,
  },
];
...
const AboutUs = () => {
  ...
  return (
    <>
            ...
            <div>
              ...
              >
                ...
                <span
                  ...
                  style={{ backgroundImage: "linear-gradient(to right, #017eeb, #00ffff)" }}
                >
                  Fast Changing
                </span>{" "}
                World.
              ...
              <p className="text-[18px] text-white/60 leading-[1.7] max-w-[600px] !mb-10">
                We create digital experiences that drive business performance — helping organizations adapt to shifts in customer behaviour and technology.
              </p>
      ...
      <section className="py-16 md:py-24" style={{ background: "#f2f9fe" }}>
        <div className="mx-auto px-5 md:px-10" style={{ maxWidth: 1280 }}>
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            <span className="inline-block mb-4" style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#017eeb" }}>
              Who We Are
            </span>
            <h2 className="font-extrabold" style={{ fontSize: "clamp(28px, 3.2vw, 42px)", letterSpacing: "-1px", lineHeight: 1.15, color: "#0d0f1a" }}>
          ...
          {MISSION_VISION.map((item) => (
            ...
            >
              <div className={item.reverse ? "lg:[direction:ltr]" : ""} style={{ direction: "ltr" }}>
                <div
                  className="w-full overflow-hidden rounded-2xl flex items-center justify-center"
                  style={{ aspectRatio: "16/9", background: "linear-gradient(135deg, #e8f0fd 0%, #c3d6fb 100%)", border: "1px solid #e5e7eb", padding: 40 }}
                >
                  <Image src={item.icon} alt={item.badge} width={160} height={160} className="w-40 h-40 object-contain" />
                </div>
              </div>
              <div className={item.reverse ? "lg:[direction:ltr]" : ""} style={{ direction: "ltr" }}>
                <span className="inline-block mb-4 text-[11px] font-bold uppercase tracking-widest" style={{ color: "#017eeb" }}>
                  {item.badge}
                </span>
                <h3 className="font-bold mb-4" style={{ fontSize: "clamp(22px, 2.4vw, 30px)", letterSpacing: "-0.3px", lineHeight: 1.3, color: "#0d0f1a" }}>
                  {item.heading}
                </h3>
                <p className="mb-5" style={{ fontSize: 16, lineHeight: 1.7, color: "#6b7280" }}>{item.body}</p>
      ...
      >
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at center, rgba(0,219,211,0.2) 0%, transparent 60%)" }} />
        <div className="relative mx-auto px-5 md:px-10" style={{ maxWidth: 700, zIndex: 1 }}>
          <h3 className="font-extrabold mb-3.5" style={{ fontSize: "clamp(24px, 3vw, 36px)", color: "#fff", lineHeight: 1.2, letterSpacing: "-0.5px" }}>
            Ready to Build Something Great Together?
          </h3>
          <p className="" style={{ color: "rgba(255,255,255,0.85)", fontSize: 16, lineHeight: 1.7 }}>
            Tell us your project idea and get a free consultation. We'll map a roadmap and estimate your timeline — no commitment.
          </p>
          <Link
            href="/contact-us/"
        ...
        <div className="mx-auto px-5 md:px-10" style={{ maxWidth: 1280 }}>
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            ...
            <p className="mt-4" style={{ fontSize: 17, lineHeight: 1.7, color: "#6b7280" }}>
              The principles that guide how we work, who we hire, and why clients come back.
            </p>
          </div>
            ...
            {BELIEFS.map((b) => (
              ...
              >
                <div className="rounded-[14px] flex items-center justify-center mb-5" style={{ width: 64, height: 64, background: b.tint }}>
                  <Image src={b.icon} alt={b.title} width={32} height={32} className="w-8 h-8 object-contain" />
                </div>
      ...
      {/* ── INDUSTRIES (dark) ───────────────────────────────────────────────── */}
      <IndustriesWeServe title="Trusted by Companies across Industries" darkBackground={true} />
