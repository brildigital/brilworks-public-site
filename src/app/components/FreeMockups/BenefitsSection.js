  ...
  const benefits = [
    {
      ...
      description:
        "Interactive prototypes so your idea feels like the real thing.",
    },
    {
      icon: <Palette className="text-white text-xl" />,
      title: "Professional Design",
      description:
        "Skip the designer hunt. You’ll get clean, polished mockups that impress investors and collaborators.",
    },
    {
      icon: <Lightbulb className="text-white text-xl" />,
      title: "Crystal Clear Vision",
      description:
        "See how your product flows, what it looks like, how users interact — before writing a single line of code.",
    },
    {
      icon: <Share className="text-white text-xl" />,
      title: "Shareable Files",
      description:
        "Ready to share with co-founders, investors, or dev teams. Figma, PDF, or whatever format works best.",
    },
  ];
