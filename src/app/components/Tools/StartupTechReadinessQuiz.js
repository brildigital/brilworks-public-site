...
const StartupTechReadinessQuiz = () => {
  ...
  return (
    <>
      <ToolHerosection
        ...
        description="Assess your startup's technology readiness with our comprehensive quiz. Get actionable insights to build a scalable, investor-ready tech foundation."
        imageSrc="/images/v2/tech-startup-quiz-simple.webp"
        statsGird={[
          { value: "2000+", label: "Used by Startups" },
          {
            value: "3x",
            label: "More Likely",
          },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto">
              Answer the questions below to get a comprehensive assessment of
              your startup's technology readiness and receive personalized
              recommendations.
            </p>
          </div>
...
export default StartupTechReadinessQuiz;
