              ...
              <div className="style_sec3_swiper_home !pt-4">
                <div className="flex items-center gap-[1rem]">
                  <div className="swiper_sec3_img1">
                    <img
                      ...
                      width="300"
                      height="300"
                      srcSet="/images/Nirmal-300x300.png 300w,
                               /images/Nirmal-150x150.png 150w,
                                /images/Nirmal.png 500w"
                ...
                <div className="service_description border-b-[1px]">
                  <p className="md:h-[150px] h-[190px]">
                    ...
                    of working in Java-based technologies.
                  </p>
                </div>
          ...
          <div className="home_sec3_box1 ">
            ...
            <div className="border-t-[1px]">
              <div className="style_sec3_swiper_home !pt-4">
                <div className="flex items-center gap-[1rem]">
                  <div className="swiper_sec3_img1">
                    <img
                      ...
                      width="300"
                      height="300"
                      srcSet="/images/rajesh-rathva-300x300.jpg 300w,
                               /images/rajesh-rathva-150x150.jpg 150w,
                                /images/rajesh-rathva.jpg 500w"
                      sizes="(max-width: 300px) 100vw, 300px"
                    />
                  </div>
                  <div className="home_sec3_txt2">
                ...
                <div className="service_description border-b-[1px]">
                  <p className="h-[150px]">
                    Highly proficient IT professional with good technical,
                    analytical, and team leadership skills. Focused,
          ...
          <div className="home_sec3_box1">
            ...
            <div className="border-t-[1px]">
              <div className="style_sec3_swiper_home !pt-4">
                ...
                <div className="service_description border-b-[1px]">
                  <p className="h-[150px]">
                    Neha has 5+ years of experience in software development. She
                    is focused on developing high-performing web, mobile, and
                    server applications.
                  </p>
                </div>
                <div className="py-[1rem] flex items-center gap-[1rem]">
