              ...
              <div className="style_sec3_swiper_home !pt-4">
                ...
                <div className="service_description border-b-[1px]">
                  <p>
                    ...
                    TypeScript, React, React Native, Redux, HTML and CSS. With
                    strong problem-solving skills and the ability to adapt to
                    any given situation.
                  </p>
                </div>
          ...
          <div className="home_sec3_box1">
            ...
            <div className="border-t-[1px]">
              <div className="style_sec3_swiper_home !pt-4 ">
                ...
                <div className="service_description border-b-[1px]">
                  <p>
                    Minal has 5+ years of experience in the design, development,
                    testing, and maintenance of software systems. He is keen at
                    observing details and good at learning anything as quickly
                    as possible.
                  </p>
                </div>
                <div className="py-[1rem] flex items-center gap-[1rem]">
              ...
              <div className="style_sec3_swiper_home !pt-4">
                ...
                <div className="service_description border-b-[1px]">
                  <p>
                    ...
                    productivity software to mission-critical react-native
                    platforms.
                  </p>
                </div>
                <div className="py-[1rem] flex items-center gap-[1rem]">
