...
const HireTeamContactFormPopup = ({ open, handleClose }) => {
  useEffect(() => {
    if (open) {
        ...
        <div className="flex flex-col lg:flex-row items-center lg:gap-10 md:gap-6 gap-4">
          ...
          <div className="lg:w-1/2 md:w-full hidden md:flex">
            <IconButton
              size="sm"
              variant="text"
              className="!absolute right-2 top-2 outline-none focus:outline-none hover:bg-gray-100 "
              onClick={handleClose}
            >
              <X className="h-5 w-5" />
            </IconButton>
...
export default HireTeamContactFormPopup;
