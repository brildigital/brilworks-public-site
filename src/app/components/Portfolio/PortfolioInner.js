...
import BrilworksSoftwareReview from "../Homepage/BrilworksSoftwareReview";
                ...
                <div className="service_txt basis-[85%]">
                  ...
                  <div className="service_description">
                    <p>
                      ...
                      detail analysis, which makes it easy to add multiple
                      filters based on geolocation, time, most viewed
                      advertising, etc.
                    </p>
                  </div>
                </div>
