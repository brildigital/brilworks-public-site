...
const CaseStudies = () => {
  ...
  return (
    <>
      <div className="lg:px-[5%] md:px-8 px-4">
        <div className="container max-w-[1280px] mx-auto">
          <section className="portfolio md:mt-32 mt-24">
            <div className="relative flex items-center justify-center">
              <div className="!bg-gradient-custom md:h-[46vh] lg:max-h-[470px] md:max-h-[300px] h-[40vh] rounded-[30px] w-full flex items-center justify-center">
            ...
            <div className="portflio_flex_row portfolio_sec reveal">
              ...
              <div className="basis-1/2">
                ...
                <div className="portfolio_sec1_txt2 portfolio_description_width">
                  <p>
                    Vugo is a seed-stage auto tech infotainment startup,
                    Mobility Media™ platform is monetizing ridesharing today,
                    and self-driving mobility services tomorrow.
                  </p>
                </div>
                <Button
            ...
            <div className="portflio_flex_row reveal">
