                ...
                <div className="w-[85%] text-left">
                  ...
                  <div className="home_sec2_txt4">
                    <p className="!leading-snug !text-left">
                      The client Eccocar reached out to Brilworks to develop a
                      web application and add a Stripe payment module to collect
                ...
                <div className="w-[85%] text-left">
                  ...
                  <div className="home_sec2_txt4">
                    <p className="!leading-snug !text-left !w-fit">
                      Brilworks was tasked with building an online payment
                      gateway for the client’s fleet management system. Eccocar
                      wanted us to integrate their platform with Stripe to
                      collect payments from customers and securely pass them on
                      to the fleet owner. Another important requirement was the
                ...
                <div className="service_txt basis-[85%]">
                  ...
                  <div className="service_description">
                    <p>
                      ...
                      that they could run smooth operations without worrying
                      about payment.
                    </p>
                  </div>
                </div>
