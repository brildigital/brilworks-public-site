...
const industries = [
  {
    name: "Fintech",
    icon: Landmark,
    desc: "Real-time payments analytics, fraud detection, and governed lakehouse data for regulated financial workloads.",
  },
  {
    name: "Healthcare",
    icon: HeartPulse,
    desc: "Patient and operational analytics on Databricks with HIPAA-aware governance and secure data sharing.",
  },
  {
    name: "Retail & E-Commerce",
    icon: ShoppingCart,
    desc: "Unified Shopify, marketplace, and ad data into one lakehouse for merchandising and growth.",
  },
  {
    name: "Logistics",
    icon: Truck,
    desc: "Spark pipelines that turn fleet, route, and warehouse data into real-time operational visibility.",
  },
  {
    name: "SaaS",
    icon: BarChart3,
    desc: "Product, billing, and usage analytics consolidated on the lakehouse so every team works from the same metrics.",
  },
  {
    name: "Manufacturing",
    icon: Factory,
...
export default DatabricksIndustries;
