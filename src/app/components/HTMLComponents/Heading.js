...
const Heading = ({ type, text, className = "", data }) => {
  ...
  const styles = {
    h1: "xl:text-[56px] lg:text-5xl md:text-[42px] text-4xl md:!leading-tight font-bold",
    h2: "xl:lg:text-5xl lg:text-[42px] md:text-4xl text-[30px] lg:!leading-tight font-bold",
