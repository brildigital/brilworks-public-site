      ...
      <section className="portfolio mt-[6rem]">
            ...
            <div className="basis-[55%]">
              <div className="home_sec2_txt4">
                <p className="!text-left">
                  ...
                  time, regardless of scale. Our experienced team offers a
                  breadth of technical expertise to meet any client’s needs from
                  finding the right talent to managing end-to-end projects.
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="endTO_text_content home_sec2_txt4">
            <p>
              We’ll understand your project needs and goals to guide you from
              the project initiation to the release phase. Depending on your
              goals, we provide consultation and an end-to-end development plan.
            </p>
          </div>
