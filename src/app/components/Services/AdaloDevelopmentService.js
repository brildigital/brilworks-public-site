...
const IconBoltSmall = ({ color = "#0d9488" }) => (
  <Zap size={18} color={color} strokeWidth={1.8} aria-hidden="true" />
);

const IconPhone = ({ color = "#0d9488" }) => (
  <Smartphone size={18} color={color} strokeWidth={1.8} aria-hidden="true" />
);

const IconClock = ({ color = "#0d9488" }) => (
  <Clock size={18} color={color} strokeWidth={1.8} aria-hidden="true" />
);

// ---------- Style tokens ----------
const heroBg = {
  background:
    "radial-gradient(900px 420px at 78% -8%, rgba(13,148,136,0.10) 0%, transparent 60%), radial-gradient(700px 360px at 8% 6%, rgba(13,148,136,0.06) 0%, transparent 55%), #f7f9fc",
};
const darkSectionBg = {
  background:
    "radial-gradient(ellipse 60% 50% at 70% 50%, rgba(13,148,136,0.06) 0%, transparent 70%), radial-gradient(ellipse 40% 60% at 20% 80%, rgba(13,148,136,0.04) 0%, transparent 60%), #f1f5fb",
};
const gradientTextStyle = { color: "#2f6bff" };
const statValueStyle = { color: "#0d9488" };
...
const BENEFITS = [
  ...
  },
  {
    ...
    icon: (
      <Zap size={32} color="#16a34a" strokeWidth={1.8} aria-hidden="true" />
    ),
  },
  {
    ...
    icon: (
      <Clock size={32} color="#7c3aed" strokeWidth={1.8} aria-hidden="true" />
    ),
  },
  {
...
const HONORS = [
  ...
  {
    label: "Adalo Expert Partner",
    icon: (
      <Zap size={20} color="#0d9488" strokeWidth={1.8} aria-hidden="true" />
    ),
  },
  {
    label: "Clutch Global Award 2025",
    icon: (
      <Star size={20} color="#0d9488" strokeWidth={1.8} aria-hidden="true" />
    ),
  },
  {
    label: "GoodFirms Top Developers",
    icon: (
      <Award size={20} color="#0d9488" strokeWidth={1.8} aria-hidden="true" />
    ),
  },
  {
...
const INDUSTRIES = [
  {
    ...
    href: "#contact",
    icon: (
      <Zap size={32} color="#0d9488" strokeWidth={1.8} aria-hidden="true" />
    ),
  },
  {
    label: "MVPs",
  ...
  },
  {
    ...
    href: "#contact",
    icon: (
      <Home size={32} color="#0d9488" strokeWidth={1.8} aria-hidden="true" />
    ),
  },
];
...
const MockupDualPhone = () => (
  <div
    className="flex items-center justify-center gap-[14px] h-full"
    style={{ background: "linear-gradient(135deg, #f0fdfa 0%, #99f6e4 100%)" }}
  >
    {[
      {
        headBg: "#0891b2",
      ...
      },
      {
        headBg: "#0d9488",
        btnBg: "#0d9488",
        screenBg: "linear-gradient(160deg, #ffffff 0%, #ecfeff 100%)",
        cards: [{ w: "80%", w2: "60%" }, { w: "70%" }, { w: "65%" }],
      },
    ].map((p, idx) => (
      <div
        key={idx}
      ...
      >
        ...
        >
          ...
          <div
            className="flex items-center justify-center mt-1.5"
            style={{ background: p.btnBg, height: 16, borderRadius: 4 }}
          >
            <span
              style={{
                background: "white",
...
const SERVICES = [
  {
    ...
    body: "We leverage Adalo's visual builder to ship feature-rich mobile and web apps on an expedited timeline. From database schema to publish-ready builds — we handle the full build while you stay focused on customers.",
    features: [
      "Native iOS & Android app publishing",
      "Custom actions & database design",
      "Performance-tuned screen logic",
    ],
  ...
  },
  {
    ...
    body: "Engaging, conversion-ready interfaces built inside Adalo's component system. Our designers hand over pixel-perfect flows, reusable components, and a brand system your app can grow with — all native to the Adalo editor.",
    features: [
      "Mobile-first wireframes & prototypes",
      "Adalo-native component library",
      "User testing & iteration loops",
    ],
    mockup: <MockupPhone />,
  ...
  },
  {
    ...
    body: "Seamlessly connect Adalo to the tools that run your business — Stripe, Airtable, Zapier, custom APIs, SMS, email, push. We build reliable integrations that don't break when your user count triples.",
    features: [
      "Stripe, Airtable, Zapier, Xano",
      "Custom REST APIs & webhooks",
      "Push notifications & SMS flows",
    ],
  ...
  },
  {
    ...
    body: "Your app doesn't stop at launch. We monitor, iterate, and ship new features on a monthly cadence — so your Adalo app stays fast, stable, and ahead of user expectations.",
    features: [
      "Dedicated Adalo support engineer",
      "Monthly feature releases & A/B tests",
    ...
    <>
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-[60px] items-center">
              <div>
                ...
                >
                  Launch No-Code Apps{" "}
                  <span style={gradientTextStyle}>in Weeks — Not Months</span>
                </h1>
                <p
                  className="mb-8"
                  style={{
                ...
                >
                  Brilworks-certified Adalo experts build and ship
                  production-ready mobile and web apps in 4-8 weeks. 20+ apps
                  launched for founders, marketplaces, and SMBs — no engineering
                  team required.
                </p>
      ...
      >
        <div className="mx-auto px-5 md:px-10" style={{ maxWidth: 1280 }}>
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            ...
            >
              Your Adalo Partner — From Idea to App Store
            </h2>
            <p
              className="mt-4"
              style={{ fontSize: 17, lineHeight: 1.7, color: "#6b7280" }}
            >
              Tailored Adalo development for founders and product teams who want
              to ship fast without writing code — backed by engineers who know
              both worlds.
            </p>
          </div>
      ...
      >
        ...
        >
          ...
          >
            Your App, Launched in 4 Weeks. Let&apos;s Start Today.
          </h3>
          <p
            className="mb-7"
            style={{
          ...
          >
            Book a free 30-minute Adalo consultation. We&apos;ll map your MVP,
            share a fixed-scope quote, and outline a timeline — no commitment.
          </p>
          <Link
            href="#contact"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="mx-auto px-5 md:px-10" style={{ maxWidth: 1280 }}>
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            ...
            >
              Built by Adalo Experts Who&apos;ve Shipped 20+ Apps
            </h2>
            <p
              className="mt-4"
              style={{ fontSize: 17, lineHeight: 1.7, color: "#6b7280" }}
            >
              We combine deep Adalo expertise with engineering rigor — so your
              no-code app ships fast and scales when users show up.
            </p>
          </div>
          <div
      ...
      >
        ...
        >
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            ...
            >
              Real words from founders, product managers, and non-technical
              builders who launched with Brilworks.
            </p>
          </div>
          <div
            className="grid gap-6"
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="mx-auto px-5 md:px-10" style={{ maxWidth: 1280 }}>
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            ...
            >
              Adalo Apps Built for No-Code-Native Verticals
            </h2>
            <p
              className="mt-4"
              style={{ fontSize: 17, lineHeight: 1.7, color: "#6b7280" }}
            >
              Not generalists — we ship Adalo apps for founders and teams in the
              spaces where no-code wins: speed, iteration, and focused scope.
            </p>
          </div>
          <div
        ...
        <div className="mx-auto px-5 md:px-10" style={{ maxWidth: 1280 }}>
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            ...
            <p
              ...
              style={{ fontSize: 17, lineHeight: 1.7, color: "#6b7280" }}
            >
              Everything founders typically ask before kicking off an Adalo
              build with us.
            </p>
          </div>
