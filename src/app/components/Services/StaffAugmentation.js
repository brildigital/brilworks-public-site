...
const TRUST = [
  ...
  { icon: <Users size={18} color="#017eeb" />, label: "100+ Pre-Vetted Engineers" },
  { icon: <Clock size={18} color="#017eeb" />, label: "7-Day Onboarding" },
  { icon: <CircleCheck size={18} color="#017eeb" />, label: "98% Client Retention" },
];
...
const HONORS = [
  ...
  { label: "Clutch Top Staffing 2024", icon: <Star size={20} color="#017eeb" /> },
...
const INDUSTRIES = [
  ...
  { label: "SaaS", href: "/saas-application-development-services/", icon: <Server size={32} color="#4f46e5" /> },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-[60px] items-center">
              <div>
                <span className="inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 mb-6 text-[12px] font-semibold uppercase"
                  ...
                  <Sparkles size={14} color="#00b4d8" /> IT Staff Augmentation Services
                </span>
