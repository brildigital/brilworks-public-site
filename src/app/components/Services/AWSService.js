...
// ---------- Data ----------
const TRUST = [
  { icon: <ShieldCheck size={18} color="#2f6bff" />, label: "AWS Advanced Consulting Partner" },
  { icon: <DollarSign size={18} color="#2f6bff" />, label: "$2M+ Saved for Clients" },
  { icon: <TrendingUp size={18} color="#2f6bff" />, label: "100+ Migrations Delivered" },
  { icon: <Clock size={18} color="#2f6bff" />, label: "99.99% Uptime SLA" },
];
...
const BENEFITS = [
  {
    ...
    icon: <ShieldCheck size={32} color="#2f6bff" />,
  },
  {
...
const HONORS = [
  { label: "AWS Advanced Consulting Partner", icon: <ShieldCheck size={20} color="#2f6bff" /> },
  { label: "Clutch Top B2B 2024", icon: <Star size={20} color="#2f6bff" /> },
  { label: "GoodFirms Top Cloud Partner", icon: <Award size={20} color="#2f6bff" /> },
  { label: "ISO 27001 Certified", icon: <BadgeCheck size={20} color="#2f6bff" /> },
  { label: "AWS Well-Architected Partner", icon: <Star size={20} color="#2f6bff" /> },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-[60px] items-center">
              <div>
                <span className="inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 mb-6 text-[12px] font-semibold uppercase border"
                  ...
                  <Diamond size={14} color="#2f6bff" /> AWS Advanced Consulting Partner
                </span>
                <h1 className="font-extrabold mb-5" style={{ fontSize: "clamp(34px, 4vw, 54px)", letterSpacing: "-1.5px", lineHeight: 1.1, color: "#0b1e33" }}>
                  Cut Cloud Costs, <span style={{ color: "#2f6bff" }}>Scale Without Limits</span>
                </h1>
      ...
      <section id="services" className="py-16 md:py-24" style={{ background: "#f1f5fb" }}>
        <div className="mx-auto px-5 md:px-10" style={{ maxWidth: 1280 }}>
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            <span className="inline-block mb-4" style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#2f6bff" }}>What We Deliver</span>
      ...
      <section className="relative overflow-hidden py-16 md:py-24 svc-dark-section-bg">
        <div className="relative mx-auto px-5 md:px-10" style={{ maxWidth: 1280, zIndex: 1 }}>
          <div className="text-center mx-auto mb-14" style={{ maxWidth: 720 }}>
            ...
            <h2 className="font-extrabold" style={{ fontSize: "clamp(28px, 3.2vw, 42px)", letterSpacing: "-1px", lineHeight: 1.15, color: "#0b1e33" }}>What CTOs &amp; DevOps Leaders Say</h2>
            <p className="mt-4" style={{ fontSize: 17, lineHeight: 1.7, color: "#566678" }}>Real outcomes from real AWS partners across SaaS, FinTech, Healthcare, and E-commerce.</p>
          </div>
          <div className="grid gap-6" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))" }}>
            {TESTIMONIALS.map((t) => (
            ...
            {FAQ.map((item, i) => (
              <details key={i} className="group overflow-hidden mb-3 transition-all"
                ...
                <summary className="list-none flex items-center justify-between gap-4 cursor-pointer"
                  ...
                  <span>{item.q}</span>
                  <span className="transition-transform group-open:rotate-45" style={{ color: "#2f6bff", fontSize: 24, fontWeight: 400, lineHeight: 1 }}>+</span>
                </summary>
