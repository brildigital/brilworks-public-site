    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        <motion.div
          ...
          className="bg-white backdrop-blur-sm border border-[#e4eaf1] rounded-2xl p-2 md:p-8 mb-8 shadow-2xl shadow-[#2f6bff1A]"
          data-testid="card-calendar-widget"
        >
          <div className="flex items-center flex-col text-center mb-2">
            <h3
              className="text-3xl font-bold mb-2 text-[#2f6bff]"
          ...
          <ul className="grid grid-cols-2 text-left text-[#566678] max-w-5xl mx-auto mt-6 space-y-2 mb-4">
          ...
          <div
            className="bg-white border border-[#e4eaf1] rounded-xl md:pt-8 min-h-[400px] h-full flex items-center justify-center"
