    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        >
          ...
          >
            Pick a slot, <span className="gradient-text">20-minute audit</span>{" "}
            <br className="md:block hidden" />
            to kickstart your 48-hour build
          </h2>
          <p
            className="text-lg text-[#94a3b8] max-w-2xl mx-auto"
            data-testid="text-calendar-subtitle"
          >
            Bring Figma, slides, or a doc. Screen sharing is enough. NDA on
            request.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center flex-col text-center mb-6">
            ...
            >
              Choose a convenient time for your 20-minute audit
            </p>
          </div>
