          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href="https://apps.apple.com/in/app/elara-prenatal-app/id6760452596"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center space-x-2 bg-black text-white px-8 md:py-4 py-3 rounded-full font-medium hover:bg-gray-800 transition-all duration-300"
                >
