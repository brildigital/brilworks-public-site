...
const Header = ({ blok }) => {
  return (
    <header>
          ...
          <div class="header_width padding_header">
            <div class="header_main_flex">
              ...
              <div class="project_pages">
                <div class="portfolio header_font hidden-xs project_pages_none">
                  <a href="portfolio/index.htm">PORTFOLIO</a>
                </div>
                <div
                  class="solutions header_font hidden-xs project_pages_none"
                  id="triggerNavigationSolution"
                >
                  <a href="javascript:void(0);" class="headerArrow_flex">
                    <p>SOLUTIONS</p>
                ...
                <div
                  class="header_font hidden-xs project_pages_none"
                ...
                <a href="contact-us/index.htm">
                  <div class="header_sec1_txt2 hidden-xs">
                    <p class="transition">LET&apos;S TALK</p>
                  </div>
                </a>
                <div class="nav_btn" id="triggerNavigationmenu">
                  <a href="javascript:void(0);">
                    <div class="btn_1">
                      <div class="bar transition top"></div>
                      <div class="bar transition bottom"></div>
                    </div>
                  </a>
                </div>
              </div>
      ...
      <div class="popup_overlay" id="mainMenuWrapperpopup"></div>
      ...
      <div class="popup_overlay" id="mainMenuWrapperpopup"></div>
      <div class="mega_menu" id="mainMenuWrappertechnology">
        <div class="menu_wrapper">
          <div class="mega_menu_width">
            <div class="mega_menu_style">
              <div class="mega_menu_txt">
      ...
      <div class="menu" id="mainMenuWrapper">
        <div class="menu_wrapper">
          <div class="width_90">
            <div class="padding_menu_header">
              <div class="flex_row_header_menu">
                <div class="flex_grid-60_header_menu">
                  <div id="accordion" class="accordion-container">
                    <article
                      class="content-entry home_txt3"
                    ...
                    >
                      ...
                      <div class="accordion-content">
                        <a href="hire-reactjs-developer/index.htm">
                          <div class="menu_mob_flex">
                            <p>REACT.JS</p>
                            <div class="mega_menu_icon">
                              <img src="images/REACT.JS.svg" alt="reactjs" />
                            </div>
                          </div>
                        </a>
                ...
                <div class="flex_grid-40_header_menu">
                  <div class="header_img1 padding_bottom_2 hidden-xs">
