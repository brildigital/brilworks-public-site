...
const BrilworksTermsAndConditions = () => {
  const [policyData, setPolicyData] = useState("");

  useEffect(() => {
    Storyblok.get("cdn/stories/terms-and-conditions", {
      ...
      <div className="md:w-4/5 w-full md:px-0 px-4">
        ...
        {policyData ? (
          <div className="brilworks-policy-page">
            {parse(policyData?.content?.content?.content)}
          </div>
        ) : (
...
export default BrilworksTermsAndConditions;
