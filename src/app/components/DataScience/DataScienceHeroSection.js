...
const rotatingPhrases = [
  { prefix: "50+", suffix: "Data Pipelines Built" },
  { prefix: "100+", suffix: "Machine Learning Models Deployed" },
  { prefix: "20+", suffix: "Industries Transformed" },
  { prefix: "99%", suffix: "Data Accuracy Maintained" },
  { prefix: "5+", suffix: "Years of Data Science Excellence" },
];
            ...
            <div className="lg:w-[58%] w-full flex flex-col items-start justify-center">
              ...
              >
                <span className="whitespace-nowrap">
                  We Turn Your Data{" "}
                  <span className="text-[#1A5CCC]">Into Decisions</span>
                </span>
                <br />
              ...
              <p className="hero-sub text-[18px] text-white/60 leading-[1.7] max-w-[600px] hero-fade-up">
                From predictive modeling to complex data pipelines — we build the data science solutions that empower your business. Actionable insights, delivered fast.
              </p>
            ...
            <div className="lg:w-[42%] w-full hidden lg:flex items-center justify-center relative">
              <div className="relative w-full max-w-[440px]">
                ...
                <div className="bg-white/[0.05] border border-white/10 rounded-2xl p-5 backdrop-blur-[10px] hero-float-main">
                  ...
                  <div className="text-xs text-white/50 leading-[1.5]">
                    Events processed per minute · 99.9% uptime
                  </div>
                  <div className="h-1 bg-white/10 rounded-full overflow-hidden mt-2.5">
                    <div
                      className="h-full rounded-full hero-bar-fill"
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2.5">
                    {["Apache Kafka", "Spark", "AWS", "Real-time"].map((tag) => (
                      <span
                        key={tag}
                ...
                <div className="absolute -bottom-9 -left-5 w-[200px] bg-white/[0.05] border border-white/10 rounded-2xl p-5 backdrop-blur-[10px] hero-float-2 z-10">
                  <div className="text-[10px] font-bold text-[#00b4d8] tracking-[0.1em] mb-3">
                    UPWORK SCORE
                  </div>
                  ...
                  <div className="text-xs text-white/50">Top Rated Data Agency</div>
                </div>
              </div>
            </div>
          </div>
