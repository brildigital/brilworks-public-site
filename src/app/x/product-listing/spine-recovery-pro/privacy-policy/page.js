    ...
    <>
      ...
      <section className="kinderland healthvault mt-[2rem] md:mx-[15px] w-full flex align-middle justify-center">
        <div className="container max-w-[1080px] main-section-padding !py-0 md:px-10 px-6 mx-auto w-full">
          <div>
            <div class="bg-white overflow-hidden text-gray-900 leading-relaxed">
              <header class="p-[clamp(18px,4vw,18px)] border-b border-gray-300">
                <h1 class="mt-2 mb-1 text-[clamp(22px,5vw,34px)] font-semibold">
                  Privacy Policy
                </h1>
              ...
              <main class="p-[clamp(18px,4vw,24px)] space-y-4">
                ...
                <section
                  id="purposes"
                  class="pt-4 border-t border-dashed border-gray-300"
                >
                  <h2 class="mb-2 text-[clamp(18px,3.8vw,22px)] font-semibold">
                  ...
                  <ul class="mt-2 pl-4 sm:pl-[18px] list-disc space-y-1">
                ...
                >
                  ...
                  <p class="font-semibold !my-4">GDPR Rights:</p>
                  <ul class="mt-2 pl-4 sm:pl-[18px] list-disc space-y-1">
                  ...
                  <p class="font-semibold !my-4">HIPAA Rights:</p>
                  <ul class="mt-2 pl-4 sm:pl-[18px] list-disc space-y-1">
                    <li>
              ...
              <footer class="border-t border-gray-300 px-[clamp(18px,4vw,28px)] py-4 text-gray-600 text-sm bg-gradient-to-t from-black/5 to-transparent">
