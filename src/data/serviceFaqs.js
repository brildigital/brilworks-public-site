...
const MobileAppDevelopmentFAQData = [
  ...
  },
  {
    ...
    answer:
      "Pricing depends on features, platform, design complexity, and integrations. Basic apps start around $30,000-$50,000, while comprehensive fitness platforms can range from $80,000-$200,000+. We provide detailed quotes after understanding your specific requirements.",
  },
  {
...
export {
  ...
  AWSConsultingFAQData,
  KubernetesConsultingFAQData,
  ProductEngineeringFAQData,
  ...
  FrappeDevelopmentFAQData,
  FlutterFlowFAQData,
  AdaloFAQData,
  StaffAugmentationFAQData,
  RapidDigitalisationFAQData,
  DedicatedTeamFAQData,
  WebAppDevelopmentFAQData,
  ReactJSDevelopmentFAQData,
  MobileAppDevelopmentFAQData,
  WhiteLabelDevelopmentFAQData,
  ReactNativeAppDevelopmentFAQData,
  FitnessAppDevelopmentFAQData,
};
